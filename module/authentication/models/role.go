...
type Permission struct {
	...
	Resource  string    `json:"resource" gorm:"not null;uniqueIndex:idx_resource_action_scope"` // e.g., "users", "products"
	Action    string    `json:"action" gorm:"not null;uniqueIndex:idx_resource_action_scope"`   // e.g., "create", "read", "update", "delete"
	Scope     string    `json:"scope" gorm:"not null;uniqueIndex:idx_resource_action_scope"`    // e.g., "own", "department", "organization", "all"
	CreatedAt time.Time `json:"created_at"`
}
