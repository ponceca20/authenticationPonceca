...
func (h *PersonaHandler) UpdatePersona(c *fiber.Ctx) error {
	...
	updated, err := h.Service.UpdatePersona(uint(id), &persona)
	if err != nil {
...
func (h *PersonaHandler) DeletePersona(c *fiber.Ctx) error {
	...
	if err := h.Service.DeletePersona(uint(id)); err != nil {
...
func (h *PersonaHandler) PatchPersona(c *fiber.Ctx) error {
	...
	persona, err := h.Service.PatchPersona(uint(id), fields)
	if err != nil {
